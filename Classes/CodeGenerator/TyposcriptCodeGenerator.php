		...
		if ($json["tt_content"]["elements"]) {
			foreach ($json["tt_content"]["elements"] as $element) {
				...
				if (!$element["hidden"]) {
					...
					} elseif ($element['key'] === "timelineimage" ||  $element['key'] === "audio" || $element['key'] === 'vimeo' || $element['key'] === 'image' || $element['key'] === 'imagewithtext' || $element['key'] === 'textwithmultipleimages' || $element['key'] === 'imagewithonlytext') {
